...
export const Bible = ({
  ...
  const svgSize = formatSize(size, 335 / 275);
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={svgSize.width}
    ...
    >
      {glow && (
        <path
          d="M28.647 1.8828L164.904 48.1288V273.934L15.0189 223.063C6.34427 220.119 0.5 211.929 0.5 202.707V22.2381C0.5 7.54119 14.8248 -2.80851 28.647 1.8828ZM165.904 273.94V48.1317L306.505 1.59088C320.298 -2.97476 334.5 7.36798 334.5 21.9971V202.582C334.5 211.863 328.582 220.091 319.829 222.988L165.904 273.94Z"
          className="blur-[10vmin] dark:opacity-60"
          style={{ fill: `var(--${fill})` }}
        />
      )}
...
export const Hexagon = ({
  ...
  const svgSize = formatSize(size, 254 / 283);
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={svgSize.width}
